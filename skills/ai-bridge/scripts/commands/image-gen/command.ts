...
import { DEFAULT_IMAGE_GEN, listModelHelpLines } from '../../lib/models.ts';
import { nonEmptyPrompt, positiveIntSeconds } from '../../lib/parsers.ts';
...
/**
 * Parse + validate the `image-gen` argv, then hand off to the impl. Bad input is
 * rejected up-front with a clean, flag-named message and a non-zero exit.
 */
